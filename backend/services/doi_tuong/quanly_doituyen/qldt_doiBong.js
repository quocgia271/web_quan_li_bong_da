...
async function viewTbody() {
    ...
    const data = await hamChung.layThongTinTheo_ID("doi_bong", DoiTuyen.getDoiTuyen_dangChon());
    console.log(data); // là 1 object

    const tableBody = document.getElementById("dataTable");
    tableBody.innerHTML = "";

    // Vì data là object, nên bọc lại thành mảng
    ...
    button_sua([data]); // vì hàm này có thể cần array
    button_xoa([data]);
